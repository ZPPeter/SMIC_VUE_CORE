...
<text name="HomeInfo" value=""></text><text name="QueryHomeInfo"  value="查询"></text><text name="CreateHomeInfo"  value="添加"></text><text name="EditHomeInfo"  value="编辑"></text><text name="DeleteHomeInfo"  value="删除"></text><text name="BatchDeleteHomeInfo" value="批量删除"></text><text name="ExportHomeInfo"  value="导出"></text>                             
