...
复制以下代码到Application层下的：SMICApplicationModule.cs
...
Configuration.Modules.AbpAutoMapper().Configurators.Add(configuration =>
{
    ...
    // 只需要复制这一段
TaskMapper.CreateMappings(configuration);
...
如果你生成了**权限功能**。复制以下代码到 SMICApplicationModule.cs
中的 PreInitialize 方法中:
...
<text name="AssignedPersonId"  value="Id"></text>
<text name="AssignedPerson"  value="分配给"></text>
<text name="Title"  value="标题"></text>
<text name="Description"  value="内容"></text>
<text name="State"  value="状态"></text>
<text name="CreationTime"  value="创建时间"></text>


<text name="Task" value="计划任务表"></text><text name="QueryTask"  value="查询计划任务表"></text><text name="CreateTask"  value="添加计划任务表"></text><text name="EditTask"  value="编辑计划任务表"></text><text name="DeleteTask"  value="删除计划任务表"></text><text name="BatchDeleteTask" value="批量删除计划任务表"></text><text name="ExportTask"  value="导出计划任务表"></text>                             
